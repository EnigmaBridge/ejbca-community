...
public interface VpnUserManagementSession {
    ...
    List<String> geVpnUsersIds(AuthenticationToken authenticationToken);

    void deleteVpnUser(AuthenticationToken authenticationToken, String vpnUserId) throws AuthorizationDeniedException;

    VpnUser getVpnUser(AuthenticationToken authenticationToken, String vpnUserId) throws AuthorizationDeniedException;
...
//    void activate(AuthenticationToken authenticationToken, int vpnUserId, char[] authenticationCode)
...
//    void deactivate(AuthenticationToken authenticationToken, int vpnUserId) throws AuthorizationDeniedException;
//
//    /**
...
//    boolean isVpnUserActive(AuthenticationToken authenticationToken, int vpnUserId) throws AuthorizationDeniedException;
//
//    /**
