...
<%  if (exception instanceof AuthorizationDeniedException || exception instanceof AuthenticationFailedException) {
        ...
        response.addHeader("content-security-policy", "default-src 'none'; style-src 'self' 'unsafe-inline'; script-src 'self'; img-src 'self'; frame-src 'self'; font-src 'self'; reflected-xss block" );
        response.addHeader("x-content-security-policy", "default-src 'none'; style-src 'self' 'unsafe-inline'; script-src 'self'; img-src 'self'; frame-src 'self'; font-src 'self'; reflected-xss block" );
