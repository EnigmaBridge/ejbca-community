 ...
 * 
 * @version $Id: EjbLocalHelper.java 20647 2015-02-10 11:07:47Z aveen4711 $
 */
public class EjbLocalHelper implements EjbBridgeSessionLocal {
	...
	@Override public VpnUserManagementSessionLocal getVpnUserManagementSession() { return getEjbLocal().getVpnUserManagementSession(); }
